...
const RestaurantSchema=new mongoose.Schema({
   ...
   verificationMessage:{type:String,default:"Your restaurant is under review.We will notify you once it is reviewed"},
   coords:{
    id:{type:String},
    lattitude:{type:Number,required:true},
    longitude:{type:Number,required:true},
    lattitudeDelta:{type:Number,default:0.0122},
